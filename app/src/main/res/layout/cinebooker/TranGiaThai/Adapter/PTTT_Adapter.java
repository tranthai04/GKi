...
public class PTTT_Adapter extends RecyclerView.Adapter<PTTT_Adapter.viewHoler> {
    ...
    @NonNull
    @Override
    public PTTT_Adapter.viewHoler onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull PTTT_Adapter.viewHoler holder, int position) {
