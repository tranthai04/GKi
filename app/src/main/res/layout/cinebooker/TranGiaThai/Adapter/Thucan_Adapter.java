...
public class Thucan_Adapter extends RecyclerView.Adapter<Thucan_Adapter.viewHoler> {
    ...
    @NonNull
    @Override
    public Thucan_Adapter.viewHoler onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull Thucan_Adapter.viewHoler holder, int position) {
