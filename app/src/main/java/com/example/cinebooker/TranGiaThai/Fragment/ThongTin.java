...
import com.example.cinebooker.TranGiaThai.Activity.SecondActivity;
...
public class ThongTin extends Fragment {
    ...
    {
        map = view.findViewById(R.id.LN1);
        map.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ActivityOpen.openActivityOnClick(requireActivity(), SecondActivity.class, R.id.map_open    );
            }
        });
